...
public class ConsumerFanout2 {
    ...
    private final static String QUEUE_NAME = "unit_fanout_queue2";

    private final static String EXCHANGE_NAME="unit_fanout_exchange";

    /**
     * 路由key
     */
    private final static String ROUTE_KEY = "unit_route_key2";
